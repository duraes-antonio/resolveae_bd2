...
SELECT US2.nome AS CONTRATANTE, US1.nome AS PRESTADOR, SE.titulo , CT.descricao AS CONTRATO, CT.horas_contratadas, SE.valor, CT.data_inicio,CT.data_fim,CT.data_ult_modif FROM servico AS SE
